...
# salva os dados limpos em um arquivo rds para analise
# futuras sem precisar repetir as preparações de dados
...
## 2 . Le o arquivo e armazena o objeto
...
# As funções summarise e group by -----------------------------------------
...
# Calcula o numero de representantes destintos nos dados:
dados_vendas_limpos |> 
...
# Calcula a receita média por cidade eproduto:
dados_vendas_limpos |> 
